...
// Browser globals
b(a._,a.Backgrid)}(this,function(a,b){var c={},d=c.TextareaEditor=b.Extension.TextareaEditor=b.CellEditor.extend({/** @property */
...
focus:function(){this.$el.find("textarea").focus()}});/**
  ...
  */
return c.TextCell=b.Extension.TextCell=b.StringCell.extend({/** @property */
